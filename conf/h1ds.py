...
class Theme(ThemeBase):
    ...
    def header(self, d, **kw):
        ...
        html = [
            ...
            u'<div id="title"><a href="/">H1 Data Server</a><div id="subtitle"><a href="/mdsplus/">MDSPlus</a> &middot; <a href="/summary/">Summary</a> &middot; <a href="/wiki">Wiki</a> &middot; <a href="http://code.h1svr.anu.edu.au">Code</a></div></div>',
            #self.trail(d),
            #self.navibar(d),
            #u'<hr id="pageline">',
