...
h=a[1]*D/180):[c/D*180,h/D*180]};return a}function fe(a,c){function h(a,c){var h=Math.sqrt(w-2*n*Math.sin(c))/n;return[h*Math.sin(a*=n),b-h*Math.cos(a)]}var v=Math.sin(a),n=(v+Math.sin(c))/2,w=1+v*(2*n-v),b=Math.sqrt(w)/n;h.invert=function(a,c){var h=b-c;return[Math.atan2(a,h)/n,Ka((w-(a*a+h*h)*n*n)/(2*n))]};return h}function bg(){function a(a,c){Ib+=n*a-v*c;v=a;n=c}var c,h,v,n;Fa.point=function(w,b){Fa.point=a;c=v=w;h=n=b};Fa.lineEnd=function(){a(c,h)}}function cg(){function a(a,c){b.push("M",a,
",",c,w)}function c(a,c){b.push("M",a,",",c);d.point=h}function h(a,c){b.push("L",a,",",c)}function v(){d.point=a}function n(){b.push("Z")}var w=ge(4.5),b=[],d={point:a,lineStart:function(){d.point=c},lineEnd:v,polygonStart:function(){d.lineEnd=n},polygonEnd:function(){d.lineEnd=v;d.point=a},pointRadius:function(a){w=ge(a);return d},result:function(){if(b.length){var a=b.join("");b=[];return a}}};return d}function ge(a){return"m0,"+a+"a"+a+","+a+" 0 1,1 0,"+-2*a+"a"+a+","+a+" 0 1,1 0,"+2*a+"z"}function Oa(a,
c){ua+=a;va+=c;++oa}function he(){function a(a,n){var w=a-c,b=n-h,w=Math.sqrt(w*w+b*b);ha+=w*(c+a)/2;ia+=w*(h+n)/2;da+=w;Oa(c=a,h=n)}var c,h;la.point=function(v,n){la.point=a;Oa(c=v,h=n)}}function ie(){la.point=Oa}function dg(){function a(a,c){var h=a-v,b=c-n,h=Math.sqrt(h*h+b*b);ha+=h*(v+a)/2;ia+=h*(n+c)/2;da+=h;h=n*a-v*c;Da+=h*(v+a);Ea+=h*(n+c);pa+=3*h;Oa(v=a,n=c)}var c,h,v,n;la.point=function(w,b){la.point=a;Oa(c=v=w,h=n=b)};la.lineEnd=function(){a(c,h)}}function eg(a){function c(c,h){a.moveTo(c,
h);a.arc(c,h,b,0,2*D)}function h(c,h){a.moveTo(c,h);d.point=v}function v(c,h){a.lineTo(c,h)}function n(){d.point=c}function w(){a.closePath()}var b=4.5,d={point:c,lineStart:function(){d.point=h},lineEnd:n,polygonStart:function(){d.lineEnd=w},polygonEnd:function(){d.lineEnd=n;d.point=c},pointRadius:function(a){b=a;return d},result:l};return d}function je(a){function c(c){function n(h,v){h=a(h,v);c.point(h[0],h[1])}function v(){y=NaN;z.point=b;c.lineStart()}function b(n,v){var d=Ma([n,v]),f=a(n,v);
h(y,p,x,r,A,B,y=f[0],p=f[1],x=n,r=d[0],A=d[1],B=d[2],w,c);c.point(y,p)}function d(){z.point=n;c.lineEnd()}function f(){v();z.point=e;z.lineEnd=g}function e(a,c){b(l=a,c);q=y;u=p;m=r;t=A;s=B;z.point=b}function g(){h(y,p,x,r,A,B,q,u,l,m,t,s,w,c);z.lineEnd=d;d()}var l,q,u,m,t,s,x,y,p,r,A,B,z={point:n,lineStart:v,lineEnd:d,polygonStart:function(){c.polygonStart();z.lineStart=f},polygonEnd:function(){c.polygonEnd();z.lineStart=v}};return z}function h(c,w,b,d,f,e,g,l,q,u,m,t,s,x){var y=g-c,p=l-w,r=y*y+
p*p;if(r>4*v&&s--){var A=d+u,B=f+m,z=e+t,H=Math.sqrt(A*A+B*B+z*z),J=Math.asin(z/=H),L=Math.abs(Math.abs(z)-1)<G?(b+q)/2:Math.atan2(B,A),Na=a(L,J),J=Na[0],Na=Na[1],C=J-c,D=Na-w,E=p*C-y*D;if(E*E/r>v||0.3<Math.abs((y*C+p*D)/r-0.5)||d*u+f*m+e*t<n)h(c,w,b,d,f,e,J,Na,L,A/=H,B/=H,z,s,x),x.point(J,Na),h(J,Na,L,A,B,z,g,l,q,u,m,t,s,x)}}var v=0.5,n=Math.cos(30*F),w=16;c.precision=function(a){if(!arguments.length)return Math.sqrt(v);w=0<(v=a*a)&&16;return c};return c}function Jb(a){this.stream=a}function fg(a){var c=
je(function(c,v){return a([c*P,v*P])});return function(a){var v=new Jb(a=c(a));v.point=function(c,v){a.point(c*F,v*F)};return v}}function Ga(a){return Pc(function(){return a})()}function Pc(a){function c(a){a=d(a[0]*F,a[1]*F);return[a[0]*e+T,Q-a[1]*e]}function h(a){return(a=d.invert((a[0]-T)/e,(Q-a[1])/e))&&[a[0]*P,a[1]*P]}function v(){d=ee(b=Qc(m,t,x),w);var a=w(q,u);T=g-a[0]*e;Q=l+a[1]*e;return n()}function n(){A&&(A.valid=!1,A=null);return c}var w,b,d,f=je(function(a,c){a=w(a,c);return[a[0]*e+
T,Q-a[1]*e]}),e=150,g=480,l=250,q=0,u=0,m=0,t=0,x=0,T,Q,S=ke,y=W,p=null,r=null,A;c.stream=function(a){A&&(A.valid=!1);A=gg(b,S(f(y(a))));A.valid=!0;return A};c.clipAngle=function(a){if(!arguments.length)return p;S=null==a?(p=a,ke):ag((p=+a)*F);return n()};c.clipExtent=function(a){if(!arguments.length)return r;y=(r=a)?de(a[0][0],a[0][1],a[1][0],a[1][1]):W;return n()};c.scale=function(a){if(!arguments.length)return e;e=+a;return v()};c.translate=function(a){if(!arguments.length)return[g,l];g=+a[0];
l=+a[1];return v()};c.center=function(a){if(!arguments.length)return[q*P,u*P];q=a[0]%360*F;u=a[1]%360*F;return v()};c.rotate=function(a){if(!arguments.length)return[m*P,t*P,x*P];m=a[0]%360*F;t=a[1]%360*F;x=2<a.length?a[2]%360*F:0;return v()};s.rebind(c,f,"precision");return function(){w=a.apply(this,arguments);c.invert=w.invert&&h;return v()}}function gg(a,c){var h=new Jb(c);h.point=function(h,n){n=a(h*F,n*F);h=n[0];c.point(h>D?h-2*D:h<-D?h+2*D:h,n[1])};return h}function ib(a,c){return[a,c]}function Qc(a,
c,h){return a?c||h?ee(le(a),me(c,h)):le(a):c||h?me(c,h):ib}function ne(a){return function(c,h){return c+=a,[c>D?c-2*D:c<-D?c+2*D:c,h]}}function le(a){var c=ne(a);c.invert=ne(-a);return c}function me(a,c){function h(a,c){var h=Math.cos(c),d=Math.cos(a)*h,h=Math.sin(a)*h,f=Math.sin(c),e=f*v+d*n;return[Math.atan2(h*w-e*b,d*v-f*n),Ka(e*w+h*b)]}var v=Math.cos(a),n=Math.sin(a),w=Math.cos(c),b=Math.sin(c);h.invert=function(a,c){var h=Math.cos(c),d=Math.cos(a)*h,h=Math.sin(a)*h,f=Math.sin(c),e=f*w-h*b;return[Math.atan2(h*
w+f*b,d*v+e*n),Ka(e*v-d*n)]};return h}function Mc(a,c){var h=Math.cos(a),v=Math.sin(a);return function(n,w,b,d){var f=b*c;if(null!=n){if(n=oe(h,n),w=oe(h,w),0<b?n<w:n>w)n+=2*b*D}else n=a+2*b*D,w=a-0.5*f;for(var e;0<b?n>w:n<w;n-=f)d.point((e=Eb([h,-v*Math.cos(n),-v*Math.sin(n)]))[0],e[1])}}function oe(a,c){var h=Ma(c);h[0]-=a;Db(h);var v=1<-h[1]?0:-1>-h[1]?D:Math.acos(-h[1]);return((0>-h[2]?-v:v)+2*Math.PI-G)%(2*Math.PI)}function pe(a,c,h){var v=s.range(a,c-G,h).concat(c);return function(a){return v.map(function(c){return[a,
c]})}}function qe(a,c,h){var v=s.range(a,c-G,h).concat(c);return function(a){return v.map(function(c){return[c,a]})}}function Rc(a){return a.source}function Sc(a){return a.target}function hg(a,c,h,v){var n=Math.cos(c),w=Math.sin(c),b=Math.cos(v),d=Math.sin(v),f=n*Math.cos(a),e=n*Math.sin(a),g=b*Math.cos(h),l=b*Math.sin(h),q=2*Math.asin(Math.sqrt(Hd(v-c)+n*b*Hd(h-a))),u=1/Math.sin(q);h=q?function(a){var c=Math.sin(a*=q)*u,h=Math.sin(q-a)*u;a=h*f+c*g;var n=h*e+c*l,c=h*w+c*d;return[Math.atan2(n,a)*P,
Math.atan2(c,Math.sqrt(a*a+n*n))*P]}:function(){return[a*P,c*P]};h.distance=q;return h}function jb(a,c){function h(c,h){var w=Math.cos(c),b=Math.cos(h),w=a(w*b);return[w*b*Math.sin(c),w*Math.sin(h)]}h.invert=function(a,h){var w=Math.sqrt(a*a+h*h),b=c(w),d=Math.sin(b),b=Math.cos(b);return[Math.atan2(a*d,w*b),Math.asin(w&&h*d/w)]};return h}function re(a,c){function h(a,c){var h=Math.abs(Math.abs(c)-D/2)<G?0:b/Math.pow(Math.tan(D/4+c/2),n);return[h*Math.sin(n*a),b-h*Math.cos(n*a)]}var v=Math.cos(a),
n=a===c?Math.sin(a):Math.log(v/Math.cos(c))/Math.log(Math.tan(D/4+c/2)/Math.tan(D/4+a/2)),b=v*Math.pow(Math.tan(D/4+a/2),n)/n;if(!n)return Kb;h.invert=function(a,c){var h=b-c,v=(0<n?1:0>n?-1:0)*Math.sqrt(a*a+h*h);return[Math.atan2(a,h)/n,2*Math.atan(Math.pow(b/v,1/n))-D/2]};return h}function se(a,c){function h(a,c){var h=b-c;return[h*Math.sin(n*a),b-h*Math.cos(n*a)]}var v=Math.cos(a),n=a===c?Math.sin(a):(v-Math.cos(c))/(c-a),b=v/n+a;if(Math.abs(n)<G)return ib;h.invert=function(a,c){var h=b-c;return[Math.atan2(a,
h)/n,b-(0<n?1:0>n?-1:0)*Math.sqrt(a*a+h*h)]};return h}function Kb(a,c){return[a,Math.log(Math.tan(D/4+c/2))]}function te(a){var c=Ga(a),h=c.scale,v=c.translate,n=c.clipExtent,b;c.scale=function(){var a=h.apply(c,arguments);return a===c?b?c.clipExtent(null):c:a};c.translate=function(){var a=v.apply(c,arguments);return a===c?b?c.clipExtent(null):c:a};c.clipExtent=function(a){var d=n.apply(c,arguments);if(d===c){if(b=null==a){var f=D*h(),e=v();n([[e[0]-f,e[1]-f],[e[0]+f,e[1]+f]])}}else b&&(d=null);return d};
return c.clipExtent(null)}function Tc(a,c){var h=Math.cos(c)*Math.sin(a);return[Math.log((1+h)/(1-h))/2,Math.atan2(Math.tan(c),Math.cos(a))]}function ue(a){function c(c){function d(){e.push("M",b(a(g),f))}for(var e=[],g=[],l=-1,I=c.length,q,u=M(h),m=M(v);++l<I;)n.call(this,q=c[l],l)?g.push([+u.call(this,q,l),+m.call(this,q,l)]):g.length&&(d(),g=[]);g.length&&d();return e.length?e.join(""):null}var h=qa,v=wa,n=hb,b=fa,d=b.key,f=0.7;c.x=function(a){if(!arguments.length)return h;h=a;return c};c.y=function(a){if(!arguments.length)return v;
v=a;return c};c.defined=function(a){if(!arguments.length)return n;n=a;return c};c.interpolate=function(a){if(!arguments.length)return d;d="function"===typeof a?b=a:(b=Uc.get(a)||fa).key;return c};c.tension=function(a){if(!arguments.length)return f;f=a;return c};return c}function qa(a){return a[0]}function wa(a){return a[1]}function fa(a){return a.join("L")}function Vc(a){for(var c=0,h=a.length,v=a[0],n=[v[0],",",v[1]];++c<h;)n.push("V",(v=a[c])[1],"H",v[0]);return n.join("")}function Wc(a){for(var c=
0,h=a.length,v=a[0],n=[v[0],",",v[1]];++c<h;)n.push("H",(v=a[c])[0],"V",v[1]);return n.join("")}function Lb(a,c){if(1>c.length||a.length!=c.length&&a.length!=c.length+2)return fa(a);var h=a.length!=c.length,v="",n=a[0],b=a[1],d=c[0],f=d,e=1;h&&(v+="Q"+(b[0]-2*d[0]/3)+","+(b[1]-2*d[1]/3)+","+b[0]+","+b[1],n=a[1],e=2);if(1<c.length)for(f=c[1],b=a[e],e++,v+="C"+(n[0]+d[0])+","+(n[1]+d[1])+","+(b[0]-f[0])+","+(b[1]-f[1])+","+b[0]+","+b[1],n=2;n<c.length;n++,e++)b=a[e],f=c[n],v+="S"+(b[0]-f[0])+","+(b[1]-
f[1])+","+b[0]+","+b[1];h&&(h=a[e],v+="Q"+(b[0]+2*f[0]/3)+","+(b[1]+2*f[1]/3)+","+h[0]+","+h[1]);return v}function Xc(a,c){for(var h=[],b=(1-c)/2,n,w=a[0],d=a[1],f=1,e=a.length;++f<e;)n=w,w=d,d=a[f],h.push([b*(d[0]-n[0]),b*(d[1]-n[1])]);return h}function ve(a){if(3>a.length)return fa(a);var c=1,h=a.length,b=a[0],n=b[0],w=b[1],d=[n,n,n,(b=a[1])[0]],f=[w,w,w,b[1]],n=[n,",",w,"L",ja(Ha,d),",",ja(Ha,f)];for(a.push(a[h-1]);++c<=h;)b=a[c],d.shift(),d.push(b[0]),f.shift(),f.push(b[1]),Yc(n,d,f);a.pop();
n.push("L",b);return n.join("")}function ja(a,c){return a[0]*c[0]+a[1]*c[1]+a[2]*c[2]+a[3]*c[3]}function Yc(a,c,h){a.push("C",ja(we,c),",",ja(we,h),",",ja(xe,c),",",ja(xe,h),",",ja(Ha,c),",",ja(Ha,h))}function Zc(a,c){return(c[1]-a[1])/(c[0]-a[0])}function ig(a,c,h,b){var n,w,d;a=b[a];n=a[0];w=a[1];a=b[c];c=a[0];d=a[1];a=b[h];return 0<(a[1]-w)*(c-n)-(d-w)*(a[0]-n)}function $c(a,c,h){return(h[0]-c[0])*(a[1]-c[1])<(h[1]-c[1])*(a[0]-c[0])}function ye(a,c,h,b){var n=a[0],w=h[0],d=c[0]-n,f=b[0]-w;a=a[1];
h=h[1];c=c[1]-a;b=b[1]-h;w=(f*(a-h)-b*(n-w))/(b*d-f*c);return[n+w*d,a+w*c]}function ze(a){var c=a[0];a=a[a.length-1];return!(c[0]-a[0]||c[1]-a[1])}function ad(a,c){var h=a.map(function(a,c){return{index:c,x:a[0],y:a[1]}}).sort(function(a,c){return a.y<c.y?-1:a.y>c.y?1:a.x<c.x?-1:a.x>c.x?1:0}),b=null,n={list:[],leftEnd:null,rightEnd:null,init:function(){n.leftEnd=n.createHalfEdge(null,"l");n.rightEnd=n.createHalfEdge(null,"l");n.leftEnd.r=n.rightEnd;n.rightEnd.l=n.leftEnd;n.list.unshift(n.leftEnd,
n.rightEnd)},createHalfEdge:function(a,c){return{edge:a,side:c,vertex:null,l:null,r:null}},insert:function(a,c){c.l=a;c.r=a.r;a.r.l=c;a.r=c},leftBound:function(a){var c=n.leftEnd;do c=c.r;while(c!=n.rightEnd&&w.rightOf(c,a));return c=c.l},del:function(a){a.l.r=a.r;a.r.l=a.l;a.edge=null},right:function(a){return a.r},left:function(a){return a.l},leftRegion:function(a){return null==a.edge?b:a.edge.region[a.side]},rightRegion:function(a){return null==a.edge?b:a.edge.region[bd[a.side]]}},w={bisect:function(a,
c){var h={region:{l:a,r:c},ep:{l:null,r:null}},b=c.x-a.x,n=c.y-a.y;h.c=a.x*b+a.y*n+0.5*(b*b+n*n);(0<b?b:-b)>(0<n?n:-n)?(h.a=1,h.b=n/b,h.c/=b):(h.b=1,h.a=b/n,h.c/=n);return h},intersect:function(a,c){var h=a.edge,b=c.edge;if(!h||!b||h.region.r==b.region.r)return null;var n=h.a*b.b-h.b*b.a;if(1E-10>Math.abs(n))return null;var v=(h.c*b.b-b.c*h.b)/n,n=(b.c*h.a-h.c*b.a)/n,d=h.region.r,w=b.region.r;d.y<w.y||d.y==w.y&&d.x<w.x?d=a:(d=c,h=b);return(h=v>=h.region.r.x)&&"l"===d.side||!h&&"r"===d.side?null:{x:v,
y:n}},rightOf:function(a,c){var h=a.edge,b=h.region.r,n=c.x>b.x;if(n&&"l"===a.side)return 1;if(!n&&"r"===a.side)return 0;if(1===h.a){var v=c.y-b.y,d=c.x-b.x,w=0,f=0;!n&&0>h.b||n&&0<=h.b?f=w=v>=h.b*d:(f=c.x+c.y*h.b>h.c,0>h.b&&(f=!f),f||(w=1));w||(b=b.x-h.region.l.x,f=h.b*(d*d-v*v)<b*v*(1+2*d/b+h.b*h.b),0>h.b&&(f=!f))}else d=h.c-h.a*c.x,h=c.y-d,v=c.x-b.x,b=d-b.y,f=h*h>v*v+b*b;return"l"===a.side?f:!f},endPoint:function(a,h,b){a.ep[h]=b;a.ep[bd[h]]&&c(a)},distance:function(a,c){var h=a.x-c.x,b=a.y-c.y;
return Math.sqrt(h*h+b*b)}},d={list:[],insert:function(a,c,h){a.vertex=c;a.ystar=c.y+h;h=0;for(var b=d.list,n=b.length;h<n;h++){var v=b[h];if(!(a.ystar>v.ystar||a.ystar==v.ystar&&c.x>v.vertex.x))break}b.splice(h,0,a)},del:function(a){for(var c=0,h=d.list,b=h.length;c<b&&h[c]!=a;++c);h.splice(c,1)},empty:function(){return 0===d.list.length},nextEvent:function(a){for(var c=0,h=d.list,b=h.length;c<b;++c)if(h[c]==a)return h[c+1];return null},min:function(){var a=d.list[0];return{x:a.vertex.x,y:a.ystar}},
extractMin:function(){return d.list.shift()}};n.init();for(var b=h.shift(),f=h.shift(),e,g,l,q,u,m,t,s,x;;)if(d.empty()||(e=d.min()),f&&(d.empty()||f.y<e.y||f.y==e.y&&f.x<e.x)){g=n.leftBound(f);l=n.right(g);t=n.rightRegion(g);x=w.bisect(t,f);m=n.createHalfEdge(x,"l");n.insert(g,m);if(s=w.intersect(g,m))d.del(g),d.insert(g,s,w.distance(s,f));g=m;m=n.createHalfEdge(x,"r");n.insert(g,m);(s=w.intersect(m,l))&&d.insert(m,s,w.distance(s,f));f=h.shift()}else if(d.empty())break;else{g=d.extractMin();q=n.left(g);
l=n.right(g);u=n.right(l);t=n.leftRegion(g);m=n.rightRegion(l);s=g.vertex;w.endPoint(g.edge,g.side,s);w.endPoint(l.edge,l.side,s);n.del(g);d.del(l);n.del(l);g="l";t.y>m.y&&(g=t,t=m,m=g,g="r");x=w.bisect(t,m);m=n.createHalfEdge(x,g);n.insert(q,m);w.endPoint(x,bd[g],s);if(s=w.intersect(q,m))d.del(q),d.insert(q,s,w.distance(s,t));(s=w.intersect(m,u))&&d.insert(m,s,w.distance(s,t))}for(g=n.right(n.leftEnd);g!=n.rightEnd;g=n.right(g))c(g.edge)}function jg(a){return a.x}function kg(a){return a.y}function Ae(){return{leaf:!0,
nodes:[],point:null,x:null,y:null}}function kb(a,c,h,b,n,d){if(!a(c,h,b,n,d)){var f=0.5*(h+n),e=0.5*(b+d);c=c.nodes;c[0]&&kb(a,c[0],h,b,f,e);c[1]&&kb(a,c[1],f,b,n,e);c[2]&&kb(a,c[2],h,e,f,d);c[3]&&kb(a,c[3],f,e,n,d)}}function cd(a,c){a=s.rgb(a);c=s.rgb(c);var h=a.r,b=a.g,n=a.b,d=c.r-h,f=c.g-b,e=c.b-n;return function(a){return"#"+Za(Math.round(h+d*a))+Za(Math.round(b+f*a))+Za(Math.round(n+e*a))}}function Be(a,c){var h={},b={},n;for(n in a)n in c?h[n]=Pa(a[n],c[n]):b[n]=a[n];for(n in c)n in a||(b[n]=
c[n]);return function(a){for(n in h)b[n]=h[n](a);return b}}function xa(a,c){c-=a=+a;return function(h){return a+c*h}}function Ce(a,c){var h,b,n=0,d=[],f=[],e,g;a+="";c+="";for(b=Mb.lastIndex=0;h=Mb.exec(c);++b)h.index&&d.push(c.substring(n,h.index)),f.push({i:d.length,x:h[0]}),d.push(null),n=Mb.lastIndex;n<c.length&&d.push(c.substring(n));b=0;for(e=f.length;(h=Mb.exec(a))&&b<e;++b)if(g=f[b],g.x==h[0]){if(g.i)if(null==d[g.i+1])for(d[g.i-1]+=g.x,d.splice(g.i,1),h=b+1;h<e;++h)f[h].i--;else for(d[g.i-
1]+=g.x+d[g.i+1],d.splice(g.i,2),h=b+1;h<e;++h)f[h].i-=2;else if(null==d[g.i+1])d[g.i]=g.x;else for(d[g.i]=g.x+d[g.i+1],d.splice(g.i+1,1),h=b+1;h<e;++h)f[h].i--;f.splice(b,1);e--;b--}else g.x=xa(parseFloat(h[0]),parseFloat(g.x));for(;b<e;)g=f.pop(),null==d[g.i+1]?d[g.i]=g.x:(d[g.i]=g.x+d[g.i+1],d.splice(g.i+1,1)),e--;return 1===d.length?null==d[0]?(g=f[0].x,function(a){return g(a)+""}):function(){return c}:function(a){for(b=0;b<e;++b)d[(g=f[b]).i]=g.x(a);return d.join("")}}function Pa(a,c){for(var h=
s.interpolators.length,b;0<=--h&&!(b=s.interpolators[h](a,c)););return b}function Nb(a,c){var h=[],b=[],n=a.length,d=c.length,f=Math.min(a.length,c.length),e;for(e=0;e<f;++e)h.push(Pa(a[e],c[e]));for(;e<n;++e)b[e]=a[e];for(;e<d;++e)b[e]=c[e];return function(a){for(e=0;e<f;++e)b[e]=h[e](a);return b}}function lg(a){return function(c){return 0>=c?0:1<=c?1:a(c)}}function De(a){return function(c){return 1-a(1-c)}}function Ee(a){return function(c){return 0.5*(0.5>c?a(2*c):2-a(2-2*c))}}function mg(a){return a*
a}function ng(a){return a*a*a}function og(a){if(0>=a)return 0;if(1<=a)return 1;var c=a*a,h=c*a;return 4*(0.5>a?h:3*(a-c)+h-0.75)}function pg(a){return 1-Math.cos(a*D/2)}function qg(a){return Math.pow(2,10*(a-1))}function rg(a){return 1-Math.sqrt(1-a*a)}function sg(a){return a<1/2.75?7.5625*a*a:a<2/2.75?7.5625*(a-=1.5/2.75)*a+0.75:a<2.5/2.75?7.5625*(a-=2.25/2.75)*a+0.9375:7.5625*(a-=2.625/2.75)*a+0.984375}function Fe(a,c){c-=a;return function(h){return Math.round(a+c*h)}}function Ge(a){var c=[a.a,
a.b],h=[a.c,a.d],b=He(c),n=c[0]*h[0]+c[1]*h[1],d=-n;h[0]+=d*c[0];h[1]+=d*c[1];d=He(h)||0;c[0]*h[1]<h[0]*c[1]&&(c[0]*=-1,c[1]*=-1,b*=-1,n*=-1);this.rotate=(b?Math.atan2(c[1],c[0]):Math.atan2(-h[0],h[1]))*P;this.translate=[a.e,a.f];this.scale=[b,d];this.skew=d?Math.atan2(n,d)*P:0}function He(a){var c=Math.sqrt(a[0]*a[0]+a[1]*a[1]);c&&(a[0]/=c,a[1]/=c);return c}function Ie(a,c){var h=[],b=[],n,d=s.transform(a),f=s.transform(c),e=d.translate,g=f.translate,l=d.rotate,q=f.rotate,u=d.skew,m=f.skew,d=d.scale,
f=f.scale;e[0]!=g[0]||e[1]!=g[1]?(h.push("translate(",null,",",null,")"),b.push({i:1,x:xa(e[0],g[0])},{i:3,x:xa(e[1],g[1])})):g[0]||g[1]?h.push("translate("+g+")"):h.push("");l!=q?(180<l-q?q+=360:180<q-l&&(l+=360),b.push({i:h.push(h.pop()+"rotate(",null,")")-2,x:xa(l,q)})):q&&h.push(h.pop()+"rotate("+q+")");u!=m?b.push({i:h.push(h.pop()+"skewX(",null,")")-2,x:xa(u,m)}):m&&h.push(h.pop()+"skewX("+m+")");d[0]!=f[0]||d[1]!=f[1]?(n=h.push(h.pop()+"scale(",null,",",null,")"),b.push({i:n-4,x:xa(d[0],f[0])},
{i:n-2,x:xa(d[1],f[1])})):1==f[0]&&1==f[1]||h.push(h.pop()+"scale("+f+")");n=b.length;return function(a){for(var c=-1,d;++c<n;)h[(d=b[c]).i]=d.x(a);return h.join("")}}function tg(a,c){c=c-(a=+a)?1/(c-a):0;return function(h){return(h-a)*c}}function ug(a,c){c=c-(a=+a)?1/(c-a):0;return function(h){return Math.max(0,Math.min(1,(h-a)*c))}}function vg(a){var c=a.source;a=a.target;var h;var b=a;if(c===b)h=c;else{h=Je(c);for(var b=Je(b),n=h.pop(),d=b.pop(),f=null;n===d;)f=n,n=h.pop(),d=b.pop();h=f}for(b=
[c];c!==h;)c=c.parent,b.push(c);for(c=b.length;a!==h;)b.splice(c,0,a),a=a.parent;return b}function Je(a){for(var c=[],h=a.parent;null!=h;)c.push(a),a=h,h=h.parent;c.push(a);return c}function wg(a){a.fixed|=2}function xg(a){a.fixed&=-7}function yg(a){a.fixed|=4;a.px=a.x;a.py=a.y}function zg(a){a.fixed&=-5}function Ke(a,c,h){var b=0,n=0;a.charge=0;if(!a.leaf)for(var d=a.nodes,f=d.length,e=-1,g;++e<f;)g=d[e],null!=g&&(Ke(g,c,h),a.charge+=g.charge,b+=g.charge*g.cx,n+=g.charge*g.cy);a.point&&(a.leaf||
(a.point.x+=Math.random()-0.5,a.point.y+=Math.random()-0.5),c*=h[a.point.index],a.charge+=a.pointCharge=c,b+=c*a.point.x,n+=c*a.point.y);a.cx=b/a.charge;a.cy=n/a.charge}function lb(a,c){s.rebind(a,c,"sort","children","value");a.nodes=a;a.links=Ag;return a}function Bg(a){return a.children}function Cg(a){return a.value}function Dg(a,c){return c.value-a.value}function Ag(a){return s.merge(a.map(function(a){return(a.children||[]).map(function(h){return{source:a,target:h}})}))}function Eg(a){return a.x}
function Fg(a){return a.y}function Gg(a,c,h){a.y0=c;a.y=h}function dd(a){return s.range(a.length)}function ed(a){var c=-1;a=a[0].length;for(var h=[];++c<a;)h[c]=0;return h}function Hg(a){for(var c=1,h=0,b=a[0][1],n,d=a.length;c<d;++c)(n=a[c][1])>b&&(h=c,b=n);return h}function Ig(a){return a.reduce(Jg,0)}function Jg(a,c){return a+c[1]}function Kg(a,c){return Le(a,Math.ceil(Math.log(c.length)/Math.LN2+1))}function Le(a,c){for(var h=-1,b=+a[0],n=(a[1]-b)/c,d=[];++h<=c;)d[h]=n*h+b;return d}function Lg(a){return[s.min(a),
s.max(a)]}function Me(a,c){return a.parent==c.parent?1:2}function fd(a){var c=a.children;return c&&c.length?c[0]:a._tree.thread}function gd(a){var c=a.children,h;return c&&(h=c.length)?c[h-1]:a._tree.thread}function Ob(a,c){var h=a.children;if(h&&(n=h.length))for(var b,n,d=-1;++d<n;)0<c(b=Ob(h[d],c),a)&&(a=b);return a}function Mg(a,c){return a.x-c.x}function Ng(a,c){return c.x-a.x}function Og(a,c){return a.depth-c.depth}function ya(a,c){function h(a,b){var d=a.children;if(d&&(l=d.length))for(var f,
e=null,g=-1,l;++g<l;)f=d[g],h(f,e),e=f;c(a,b)}h(a,null)}function Pg(a,c){return a.value-c.value}function hd(a,c){var h=a._pack_next;a._pack_next=c;c._pack_prev=a;c._pack_next=h;h._pack_prev=c}function Ne(a,c){a._pack_next=c;c._pack_prev=a}function Oe(a,c){var h=c.x-a.x,b=c.y-a.y,n=a.r+c.r;return 0.999*n*n>h*h+b*b}function Pe(a){function c(a){b=Math.min(a.x-a.r,b);n=Math.max(a.x+a.r,n);d=Math.min(a.y-a.r,d);f=Math.max(a.y+a.r,f)}if((h=a.children)&&(t=h.length)){var h,b=Infinity,n=-Infinity,d=Infinity,
f=-Infinity,e,g,l,q,u,m,t;h.forEach(Qg);e=h[0];e.x=-e.r;e.y=0;c(e);if(1<t&&(g=h[1],g.x=g.r,g.y=0,c(g),2<t))for(l=h[2],Qe(e,g,l),c(l),hd(e,l),e._pack_prev=l,hd(l,g),g=e._pack_next,q=3;q<t;q++){Qe(e,g,l=h[q]);var s=0,x=1,y=1;for(u=g._pack_next;u!==g;u=u._pack_next,x++)if(Oe(u,l)){s=1;break}if(1==s)for(m=e._pack_prev;m!==u._pack_prev&&!Oe(m,l);m=m._pack_prev,y++);s?(x<y||x==y&&g.r<e.r?Ne(e,g=u):Ne(e=m,g),q--):(hd(e,l),g=l,c(l))}e=(b+n)/2;g=(d+f)/2;for(q=u=0;q<t;q++)l=h[q],l.x-=e,l.y-=g,u=Math.max(u,
l.r+Math.sqrt(l.x*l.x+l.y*l.y));a.r=u;h.forEach(Rg)}}function Qg(a){a._pack_next=a._pack_prev=a}function Rg(a){delete a._pack_next;delete a._pack_prev}function Re(a,c,h,b){var d=a.children;a.x=c+=b*a.x;a.y=h+=b*a.y;a.r*=b;if(d){a=-1;for(var f=d.length;++a<f;)Re(d[a],c,h,b)}}function Qe(a,c,h){var b=a.r+h.r,d=c.x-a.x,f=c.y-a.y;if(b&&(d||f)){var e=c.r+h.r,g=d*d+f*f,e=e*e,b=b*b;c=0.5+(b-e)/(2*g);e=Math.sqrt(Math.max(0,2*e*(b+g)-(b-=g)*b-e*e))/(2*g);h.x=a.x+c*d+e*f;h.y=a.y+c*f-e*d}else h.x=a.x+b,h.y=
a.y}function Sg(a){return 1+s.max(a,function(a){return a.y})}function Tg(a){return a.reduce(function(a,h){return a+h.x},0)/a.length}function Se(a){var c=a.children;return c&&c.length?Se(c[0]):a}function Te(a){var c=a.children,h;return c&&(h=c.length)?Te(c[h-1]):a}function id(a){return{x:a.x,y:a.y,dx:a.dx,dy:a.dy}}function Ue(a,c){var h=a.x+c[3],b=a.y+c[0],d=a.dx-c[1]-c[3],f=a.dy-c[0]-c[2];0>d&&(h+=d/2,d=0);0>f&&(b+=f/2,f=0);return{x:h,y:b,dx:d,dy:f}}function bb(a){var c=a[0];a=a[a.length-1];return c<
a?[c,a]:[a,c]}function Pb(a){return a.rangeExtent?a.rangeExtent():bb(a.range())}function Ug(a,c,h,b){var d=h(a[0],a[1]),f=b(c[0],c[1]);return function(a){return f(d(a))}}function Qb(a,c){var h=0,b=a.length-1,d=a[h],f=a[b],e;f<d&&(e=h,h=b,b=e,e=d,d=f,f=e);a[h]=c.floor(d);a[b]=c.ceil(f);return a}function Ve(a){return a?{floor:function(c){return Math.floor(c/a)*a},ceil:function(c){return Math.ceil(c/a)*a}}:Vg}function Wg(a,c,h,b){var d=[],f=[],e=0,g=Math.min(a.length,c.length)-1;a[g]<a[0]&&(a=a.slice().reverse(),
c=c.slice().reverse());for(;++e<=g;)d.push(h(a[e-1],a[e])),f.push(b(c[e-1],c[e]));return function(c){var h=s.bisect(a,c,1,g)-1;return f[h](d[h](c))}}function We(a,c,h,b){function d(){var n=2<Math.min(a.length,c.length)?Wg:Ug,l=b?ug:tg;e=n(a,c,l,h);g=n(c,a,l,Pa);return f}function f(a){return e(a)}var e,g;f.invert=function(a){return g(a)};f.domain=function(c){if(!arguments.length)return a;a=c.map(Number);return d()};f.range=function(a){if(!arguments.length)return c;c=a;return d()};f.rangeRound=function(a){return f.range(a).interpolate(Fe)};
f.clamp=function(a){if(!arguments.length)return b;b=a;return d()};f.interpolate=function(a){if(!arguments.length)return h;h=a;return d()};f.ticks=function(c){return s.range.apply(s,Ia(a,c))};f.tickFormat=function(c,h){return jd(a,c,h)};f.nice=function(c){Qb(a,Ve(Ia(a,c)[2]));return d()};f.copy=function(){return We(a,c,h,b)};return d()}function kd(a,c){return s.rebind(a,c,"range","rangeRound","interpolate","clamp")}function Ia(a,c){null==c&&(c=10);var h=bb(a),b=h[1]-h[0],d=Math.pow(10,Math.floor(Math.log(b/
c)/Math.LN10)),b=c/b*d;0.15>=b?d*=10:0.35>=b?d*=5:0.75>=b&&(d*=2);h[0]=Math.ceil(h[0]/d)*d;h[1]=Math.floor(h[1]/d)*d+0.5*d;h[2]=d;return h}function jd(a,c,h){var b=-Math.floor(Math.log(Ia(a,c)[2])/Math.LN10+0.01);return s.format(h?h.replace(Xe,function(a,c,h,d,f,e,g,l,q,u){return[c,h,d,f,e,g,l,q||"."+(b-2*("%"===u)),u].join("")}):",."+b+"f")}function Ye(a,c,h,b){function d(a){return(h?Math.log(0>a?0:a):-Math.log(0<a?0:-a))/Math.log(c)}function f(a){return h?Math.pow(c,a):-Math.pow(c,-a)}function e(c){return a(d(c))}
e.invert=function(c){return f(a.invert(c))};e.domain=function(c){if(!arguments.length)return b;h=0<=c[0];a.domain((b=c.map(Number)).map(d));return e};e.base=function(h){if(!arguments.length)return c;c=+h;a.domain(b.map(d));return e};e.nice=function(){var c=Qb(b.map(d),h?Math:Xg);a.domain(c);b=c.map(f);return e};e.ticks=function(){var a=bb(b),e=[],g=a[0],a=a[1],l=Math.floor(d(g)),q=Math.ceil(d(a)),u=c%1?2:c;if(isFinite(q-l)){if(h){for(;l<q;l++)for(var I=1;I<u;I++)e.push(f(l)*I);e.push(f(l))}else for(e.push(f(l));l++<
q;)for(I=u-1;0<I;I--)e.push(f(l)*I);for(l=0;e[l]<g;l++);for(q=e.length;e[q-1]>a;q--);e=e.slice(l,q)}return e};e.tickFormat=function(a,c){if(!arguments.length)return Ze;2>arguments.length?c=Ze:"function"!==typeof c&&(c=s.format(c));var b=Math.max(0.1,a/e.ticks().length),v=h?(g=1E-12,Math.ceil):(g=-1E-12,Math.floor),g;return function(a){return a/f(v(d(a)+g))<=b?c(a):""}};e.copy=function(){return Ye(a.copy(),c,h,b)};return kd(e,a)}function $e(a,c,h){function b(c){return a(d(c))}var d=Rb(c),f=Rb(1/c);
b.invert=function(c){return f(a.invert(c))};b.domain=function(c){if(!arguments.length)return h;a.domain((h=c.map(Number)).map(d));return b};b.ticks=function(a){return s.range.apply(s,Ia(h,a))};b.tickFormat=function(a,c){return jd(h,a,c)};b.nice=function(a){return b.domain(Qb(h,Ve(Ia(h,a)[2])))};b.exponent=function(e){if(!arguments.length)return c;d=Rb(c=e);f=Rb(1/c);a.domain(h.map(d));return b};b.copy=function(){return $e(a.copy(),c,h)};return kd(b,a)}function Rb(a){return function(c){return 0>c?
-Math.pow(-c,a):Math.pow(c,a)}}function af(a,c){function h(c){return w[((f.get(c)||f.set(c,a.push(c)))-1)%w.length]}function d(c,h){return s.range(a.length).map(function(a){return c+h*a})}var f,w,e;h.domain=function(d){if(!arguments.length)return a;a=[];f=new b;for(var v=-1,w=d.length,e;++v<w;)f.has(e=d[v])||f.set(e,a.push(e));return h[c.t].apply(h,c.a)};h.range=function(a){if(!arguments.length)return w;w=a;e=0;c={t:"range",a:arguments};return h};h.rangePoints=function(b,f){2>arguments.length&&(f=
0);var n=b[0],g=b[1],l=(g-n)/(Math.max(1,a.length-1)+f);w=d(2>a.length?(n+g)/2:n+l*f/2,l);e=0;c={t:"rangePoints",a:arguments};return h};h.rangeBands=function(b,f,n){2>arguments.length&&(f=0);3>arguments.length&&(n=f);var g=b[1]<b[0],l=b[g-0],q=(b[1-g]-l)/(a.length-f+2*n);w=d(l+q*n,q);g&&w.reverse();e=q*(1-f);c={t:"rangeBands",a:arguments};return h};h.rangeRoundBands=function(b,f,n){2>arguments.length&&(f=0);3>arguments.length&&(n=f);var g=b[1]<b[0],l=b[g-0],q=b[1-g],u=Math.floor((q-l)/(a.length-f+
2*n));w=d(l+Math.round((q-l-(a.length-f)*u)/2),u);g&&w.reverse();e=Math.round(u*(1-f));c={t:"rangeRoundBands",a:arguments};return h};h.rangeBand=function(){return e};h.rangeExtent=function(){return bb(c.a[0])};h.copy=function(){return af(a,c)};return h.domain(a)}function bf(a,c){function h(){var h=0,f=c.length;for(d=[];++h<f;)d[h-1]=s.quantile(a,h/f);return b}function b(a){if(!isNaN(a=+a))return c[s.bisect(d,a)]}var d;b.domain=function(c){if(!arguments.length)return a;a=c.filter(function(a){return!isNaN(a)}).sort(s.ascending);
return h()};b.range=function(a){if(!arguments.length)return c;c=a;return h()};b.quantiles=function(){return d};b.invertExtent=function(h){h=c.indexOf(h);return 0>h?[NaN,NaN]:[0<h?d[h-1]:a[0],h<d.length?d[h]:a[a.length-1]]};b.copy=function(){return bf(a,c)};return h()}function cf(a,c,h){function b(c){return h[Math.max(0,Math.min(e,Math.floor(f*(c-a))))]}function d(){f=h.length/(c-a);e=h.length-1;return b}var f,e;b.domain=function(h){if(!arguments.length)return[a,c];a=+h[0];c=+h[h.length-1];return d()};
b.range=function(a){if(!arguments.length)return h;h=a;return d()};b.invertExtent=function(c){c=h.indexOf(c);c=0>c?NaN:c/f+a;return[c,c+1/f]};b.copy=function(){return cf(a,c,h)};return d()}function df(a,c){function h(h){if(h<=h)return c[s.bisect(a,h)]}h.domain=function(c){if(!arguments.length)return a;a=c;return h};h.range=function(a){if(!arguments.length)return c;c=a;return h};h.invertExtent=function(h){h=c.indexOf(h);return[a[h-1],a[h]]};h.copy=function(){return df(a,c)};return h}function ef(a){function c(a){return+a}
c.invert=c;c.domain=c.range=function(h){if(!arguments.length)return a;a=h.map(c);return c};c.ticks=function(c){return s.range.apply(s,Ia(a,c))};c.tickFormat=function(c,b){return jd(a,c,b)};c.copy=function(){return ef(a)};return c}function Yg(a){return a.innerRadius}function Zg(a){return a.outerRadius}function ff(a){return a.startAngle}function gf(a){return a.endAngle}function hf(a){for(var c,h=-1,b=a.length,d,f;++h<b;)c=a[h],d=c[0],f=c[1]+Qa,c[0]=d*Math.cos(f),c[1]=d*Math.sin(f);return a}function jf(a){function c(c){function l(){O.push("M",
g(a(s),m),u,q(a(t.reverse()),m),"Z")}for(var O=[],t=[],s=[],x=-1,y=c.length,p,r=M(h),A=M(d),B=h===b?function(){return H}:M(b),z=d===f?function(){return J}:M(f),H,J;++x<y;)e.call(this,p=c[x],x)?(t.push([H=+r.call(this,p,x),J=+A.call(this,p,x)]),s.push([+B.call(this,p,x),+z.call(this,p,x)])):t.length&&(l(),t=[],s=[]);t.length&&l();return O.length?O.join(""):null}var h=qa,b=qa,d=0,f=wa,e=hb,g=fa,l=g.key,q=g,u="L",m=0.7;c.x=function(a){if(!arguments.length)return b;h=b=a;return c};c.x0=function(a){if(!arguments.length)return h;
h=a;return c};c.x1=function(a){if(!arguments.length)return b;b=a;return c};c.y=function(a){if(!arguments.length)return f;d=f=a;return c};c.y0=function(a){if(!arguments.length)return d;d=a;return c};c.y1=function(a){if(!arguments.length)return f;f=a;return c};c.defined=function(a){if(!arguments.length)return e;e=a;return c};c.interpolate=function(a){if(!arguments.length)return l;l="function"===typeof a?g=a:(g=Uc.get(a)||fa).key;q=g.reverse||g;u=g.closed?"M":"L";return c};c.tension=function(a){if(!arguments.length)return m;
m=a;return c};return c}function $g(a){return a.radius}function kf(a){return[a.x,a.y]}function ah(a){return function(){var c=a.apply(this,arguments),h=c[0],c=c[1]+Qa;return[h*Math.cos(c),h*Math.sin(c)]}}function bh(){return 64}function ch(){return"circle"}function lf(a){a=Math.sqrt(a/D);return"M0,"+a+"A"+a+","+a+" 0 1,1 0,"+-a+"A"+a+","+a+" 0 1,1 0,"+a+"Z"}function mb(a,c){ob(a,U);a.id=c;return a}function ld(a,c,h,b){var d=a.id;return V(a,"function"===typeof h?function(a,f,e){a.__transition__[d].tween.set(c,
b(h.call(a,a.__data__,f,e)))}:(h=b(h),function(a){a.__transition__[d].tween.set(c,h)}))}function dh(a){null==a&&(a="");return function(){this.textContent=a}}function Sb(a,c,h,d){var f=a.__transition__||(a.__transition__={active:0,count:0}),e=f[h];if(!e){var g=d.time,e=f[h]={tween:new b,time:g,ease:d.ease,delay:d.delay,duration:d.duration};++f.count;s.timer(function(b){function d(b){if(f.active>h)return l();f.active=h;e.event&&e.event.start.call(a,q,c);e.tween.forEach(function(h,b){(b=b.call(a,q,c))&&
s.push(b)});if(v(b))return 1;Td(v,0,g)}function v(b){if(f.active!==h)return l();b=(b-m)/t;for(var d=u(b),g=s.length;0<g;)s[--g].call(a,d);if(1<=b)return e.event&&e.event.end.call(a,q,c),l()}function l(){--f.count?delete f[h]:delete a.__transition__;return 1}var q=a.__data__,u=e.ease,m=e.delay,t=e.duration,s=[];if(m<=b)return d(b);Td(d,m,g)},0,g)}}function mf(a,c){a.attr("transform",function(a){return"translate("+c(a)+",0)"})}function nf(a,c){a.attr("transform",function(a){return"translate(0,"+c(a)+
")"})}function za(){this._=new Date(1<arguments.length?Date.UTC.apply(this,arguments):arguments[0])}function Ra(a,c,h){function b(c){var h=a(c),d=f(h,1);return c-h<d-c?h:d}function d(h){c(h=a(new Y(h-1)),1);return h}function f(a,h){c(a=new Y(+a),h);return a}function e(a,b,f){a=d(a);var v=[];if(1<f)for(;a<b;)h(a)%f||v.push(new Date(+a)),c(a,1);else for(;a<b;)v.push(new Date(+a)),c(a,1);return v}a.floor=a;a.round=b;a.ceil=d;a.offset=f;a.range=e;var g=a.utc=Tb(a);g.floor=g;g.round=Tb(b);g.ceil=Tb(d);
g.offset=Tb(f);g.range=function(a,c,h){try{Y=za;var b=new za;b._=a;return e(b,c,h)}finally{Y=Date}};return a}function Tb(a){return function(c,h){try{Y=za;var b=new za;b._=c;return a(b,h)._}finally{Y=Date}}}function ba(a){function c(c){for(var b=[],d=-1,f=0,e,g;++d<h;)if(37===a.charCodeAt(d)){b.push(a.substring(f,d));null!=(e=of[f=a.charAt(++d)])&&(f=a.charAt(++d));if(g=Ub[f])f=g(c,null==e?"e"===f?" ":"0":e);b.push(f);f=d+1}b.push(a.substring(f,d));return b.join("")}var h=a.length;c.parse=function(c){var h=
{y:1900,m:0,d:1,H:0,M:0,S:0,L:0,Z:null};if(Vb(h,a,c,0)!=c.length)return null;"p"in h&&(h.H=h.H%12+12*h.p);c=null!=h.Z&&Y!==za;var b=new (c?za:Y);"j"in h?b.setFullYear(h.y,0,h.j):"w"in h&&("W"in h||"U"in h)?(b.setFullYear(h.y,0,1),b.setFullYear(h.y,0,"W"in h?(h.w+6)%7+7*h.W-(b.getDay()+5)%7:h.w+7*h.U-(b.getDay()+6)%7)):b.setFullYear(h.y,h.m,h.d);b.setHours(h.H+Math.floor(h.Z/100),h.M+h.Z%100,h.S,h.L);return c?b._:b};c.toString=function(){return a};return c}function Vb(a,c,h,b){for(var d,f=0,e=c.length,
g=h.length;f<e;){if(b>=g)return-1;d=c.charCodeAt(f++);if(37===d){if(d=c.charAt(f++),d=eh[d in of?c.charAt(f++):d],!d||0>(b=d(a,h,b)))return-1}else if(d!=h.charCodeAt(b++))return-1}return b}function Wb(a){return RegExp("^(?:"+a.map(s.requote).join("|")+")","i")}function Xb(a){for(var c=new b,h=-1,d=a.length;++h<d;)c.set(a[h].toLowerCase(),h);return c}function ca(a,c,h){var b=0>a?"-":"";a=(b?-a:a)+"";var d=a.length;return b+(d<h?Array(h-d+1).join(c)+a:a)}function pf(a,c,h){R.lastIndex=0;return(c=R.exec(c.substring(h,
h+2)))?(a.d=+c[0],h+c[0].length):-1}function qf(a,c,h){R.lastIndex=0;return(c=R.exec(c.substring(h,h+2)))?(a.H=+c[0],h+c[0].length):-1}function ra(a){function c(a){try{Y=za;var c=new Y;c._=a;return h(c)}finally{Y=Date}}var h=ba(a);c.parse=function(a){try{Y=za;var c=h.parse(a);return c&&c._}finally{Y=Date}};c.toString=h.toString;return c}function md(a){return a.toISOString()}function nd(a,c,h){function b(c){return a(c)}function d(a,h){var b=(a[1]-a[0])/h,f=s.bisect(Yb,b);return f==Yb.length?[c.year,
Ia(a.map(function(a){return a/31536E6}),h)[2]]:f?c[b/Yb[f-1]<Yb[f]/b?f-1:f]:[fh,Ia(a,h)[2]]}b.invert=function(c){return Sa(a.invert(c))};b.domain=function(c){if(!arguments.length)return a.domain().map(Sa);a.domain(c);return b};b.nice=function(a,c){function h(b){return!isNaN(b)&&!a.range(b,Sa(+b+1),c).length}var f=b.domain(),e=bb(f);if(e=null==a?d(e,10):"number"===typeof a&&d(e,a))a=e[0],c=e[1];return b.domain(Qb(f,1<c?{floor:function(c){for(;h(c=a.floor(c));)c=Sa(c-1);return c},ceil:function(c){for(;h(c=
a.ceil(c));)c=Sa(+c+1);return c}}:a))};b.ticks=function(a,c){var h=bb(b.domain()),f=null==a?d(h,10):"number"===typeof a?d(h,a):!a.range&&[{range:a},c];f&&(a=f[0],c=f[1]);return a.range(h[0],Sa(+h[1]+1),c)};b.tickFormat=function(){return h};b.copy=function(){return nd(a.copy(),c,h)};return kd(b,a)}function Sa(a){return new Date(a)}function rf(a){return function(c){for(var h=a.length-1,b=a[h];!b[1](c);)b=a[--h];return b[0](c)}}function gh(a){return JSON.parse(a.responseText)}function hh(a){var c=ga.createRange();
c.selectNode(ga.body);return c.createContextualFragment(a.responseText)}var s={version:"3.3.3"};Date.now||(Date.now=function(){return+new Date});var ih=[].slice,Ba=function(a){return ih.call(a)},ga=document,Ca=ga.documentElement,X=window;try{Ba(Ca.childNodes)[0].nodeType}catch(Rh){Ba=function(a){for(var c=a.length,h=Array(c);c--;)h[c]=a[c];return h}}try{ga.createElement("div").style.setProperty("opacity",0,"")}catch(Sh){var Zb=X.Element.prototype,jh=Zb.setAttribute,kh=Zb.setAttributeNS,sf=X.CSSStyleDeclaration.prototype,
lh=sf.setProperty;Zb.setAttribute=function(a,c){jh.call(this,a,c+"")};Zb.setAttributeNS=function(a,c,h){kh.call(this,a,c,h+"")};sf.setProperty=function(a,c,h){lh.call(this,a,c+"",h)}}s.ascending=function(a,c){return a<c?-1:a>c?1:a>=c?0:NaN};s.descending=function(a,c){return c<a?-1:c>a?1:c>=a?0:NaN};s.min=function(a,c){var h=-1,b=a.length,d,f;if(1===arguments.length){for(;++h<b&&!(null!=(d=a[h])&&d<=d);)d=void 0;for(;++h<b;)null!=(f=a[h])&&d>f&&(d=f)}else{for(;++h<b&&!(null!=(d=c.call(a,a[h],h))&&
d<=d);)d=void 0;for(;++h<b;)null!=(f=c.call(a,a[h],h))&&d>f&&(d=f)}return d};s.max=function(a,c){var h=-1,b=a.length,d,f;if(1===arguments.length){for(;++h<b&&!(null!=(d=a[h])&&d<=d);)d=void 0;for(;++h<b;)null!=(f=a[h])&&f>d&&(d=f)}else{for(;++h<b&&!(null!=(d=c.call(a,a[h],h))&&d<=d);)d=void 0;for(;++h<b;)null!=(f=c.call(a,a[h],h))&&f>d&&(d=f)}return d};s.extent=function(a,c){var h=-1,b=a.length,d,f,e;if(1===arguments.length){for(;++h<b&&!(null!=(d=e=a[h])&&d<=d);)d=e=void 0;for(;++h<b;)null!=(f=a[h])&&
(d>f&&(d=f),e<f&&(e=f))}else{for(;++h<b&&!(null!=(d=e=c.call(a,a[h],h))&&d<=d);)d=void 0;for(;++h<b;)null!=(f=c.call(a,a[h],h))&&(d>f&&(d=f),e<f&&(e=f))}return[d,e]};s.sum=function(a,c){var h=0,b=a.length,d,f=-1;if(1===arguments.length)for(;++f<b;)isNaN(d=+a[f])||(h+=d);else for(;++f<b;)isNaN(d=+c.call(a,a[f],f))||(h+=d);return h};s.mean=function(a,c){var h=a.length,b,d=0,f=-1,e=0;if(1===arguments.length)for(;++f<h;)m(b=a[f])&&(d+=(b-d)/++e);else for(;++f<h;)m(b=c.call(a,a[f],f))&&(d+=(b-d)/++e);
return e?d:void 0};s.quantile=function(a,c){var h=(a.length-1)*c+1,b=Math.floor(h),d=+a[b-1];return(h-=b)?d+h*(a[b]-d):d};s.median=function(a,c){1<arguments.length&&(a=a.map(c));a=a.filter(m);return a.length?s.quantile(a.sort(s.ascending),0.5):void 0};s.bisector=function(a){return{left:function(c,h,b,d){3>arguments.length&&(b=0);4>arguments.length&&(d=c.length);for(;b<d;){var f=b+d>>>1;a.call(c,c[f],f)<h?b=f+1:d=f}return b},right:function(c,h,b,d){3>arguments.length&&(b=0);4>arguments.length&&(d=
c.length);for(;b<d;){var f=b+d>>>1;h<a.call(c,c[f],f)?d=f:b=f+1}return b}}};var tf=s.bisector(function(a){return a});s.bisectLeft=tf.left;s.bisect=s.bisectRight=tf.right;s.shuffle=function(a){for(var c=a.length,h,b;c;)b=Math.random()*c--|0,h=a[c],a[c]=a[b],a[b]=h;return a};s.permute=function(a,c){for(var h=c.length,b=Array(h);h--;)b[h]=a[c[h]];return b};s.pairs=function(a){for(var c=0,h=a.length-1,b=a[0],d=Array(0>h?0:h);c<h;)d[c]=[b,b=a[++c]];return d};s.zip=function(){if(!(d=arguments.length))return[];
for(var a=-1,c=s.min(arguments,r),h=Array(c);++a<c;)for(var b=-1,d,f=h[a]=Array(d);++b<d;)f[b]=arguments[b][a];return h};s.transpose=function(a){return s.zip.apply(s,a)};s.keys=function(a){var c=[],h;for(h in a)c.push(h);return c};s.values=function(a){var c=[],h;for(h in a)c.push(a[h]);return c};s.entries=function(a){var c=[],h;for(h in a)c.push({key:h,value:a[h]});return c};s.merge=function(a){return Array.prototype.concat.apply([],a)};s.range=function(a,c,h){3>arguments.length&&(h=1,2>arguments.length&&
(c=a,a=0));if(Infinity===(c-a)/h)throw Error("infinite range");var b=[],d;d=Math.abs(h);for(var f=1;d*f%1;)f*=10;d=f;var f=-1,e;a*=d;c*=d;h*=d;if(0>h)for(;(e=a+h*++f)>c;)b.push(e/d);else for(;(e=a+h*++f)<c;)b.push(e/d);return b};s.map=function(a){var c=new b;if(a instanceof b)a.forEach(function(a,h){c.set(a,h)});else for(var h in a)c.set(h,a[h]);return c};p(b,{has:function(a){return Ja+a in this},get:function(a){return this[Ja+a]},set:function(a,c){return this[Ja+a]=c},remove:function(a){a=Ja+a;return a in
this&&delete this[a]},keys:function(){var a=[];this.forEach(function(c){a.push(c)});return a},values:function(){var a=[];this.forEach(function(c,h){a.push(h)});return a},entries:function(){var a=[];this.forEach(function(c,h){a.push({key:c,value:h})});return a},forEach:function(a){for(var c in this)c.charCodeAt(0)===uf&&a.call(this,c.substring(1),this[c])}});var Ja="\x00",uf=Ja.charCodeAt(0);s.nest=function(){function a(c,f,n){if(n>=d.length)return g?g.call(h,f):e?f.sort(e):f;for(var l=-1,q=f.length,
u=d[n++],m,t,s=new b,x;++l<q;)(x=s.get(m=u(t=f[l])))?x.push(t):s.set(m,[t]);c?(t=c(),f=function(h,b){t.set(h,a(c,b,n))}):(t={},f=function(h,b){t[h]=a(c,b,n)});s.forEach(f);return t}function c(a,h){if(h>=d.length)return a;var b=[],e=f[h++];a.forEach(function(a,d){b.push({key:a,values:c(d,h)})});return e?b.sort(function(a,c){return e(a.key,c.key)}):b}var h={},d=[],f=[],e,g;h.map=function(c,h){return a(h,c,0)};h.entries=function(h){return c(a(s.map,h,0),0)};h.key=function(a){d.push(a);return h};h.sortKeys=
function(a){f[d.length-1]=a;return h};h.sortValues=function(a){e=a;return h};h.rollup=function(a){g=a;return h};return h};s.set=function(a){var c=new d;if(a)for(var h=0,b=a.length;h<b;++h)c.add(a[h]);return c};p(d,{has:function(a){return Ja+a in this},add:function(a){this[Ja+a]=!0;return a},remove:function(a){a=Ja+a;return a in this&&delete this[a]},values:function(){var a=[];this.forEach(function(c){a.push(c)});return a},forEach:function(a){for(var c in this)c.charCodeAt(0)===uf&&a.call(this,c.substring(1))}});
s.behavior={};s.rebind=function(a,c){for(var h=1,b=arguments.length,d;++h<b;)a[d=arguments[h]]=g(a,c,c[d]);return a};var Ad="webkit ms moz Moz o O".split(" ");s.dispatch=function(){for(var a=new f,c=-1,h=arguments.length;++c<h;)a[arguments[c]]=q(a);return a};f.prototype.on=function(a,c){var h=a.indexOf("."),b="";0<=h&&(b=a.substring(h+1),a=a.substring(0,h));if(a)return 2>arguments.length?this[a].on(b):this[a].on(b,c);if(2===arguments.length){if(null==c)for(a in this)if(this.hasOwnProperty(a))this[a].on(b,
null);return this}};s.event=null;s.requote=function(a){return a.replace(mh,"\\$&")};var mh=/[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g,ob={}.__proto__?function(a,c){a.__proto__=c}:function(a,c){for(var h in c)a[h]=c[h]},nc=function(a,c){return c.querySelector(a)},oc=function(a,c){return c.querySelectorAll(a)},nh=Ca[e(Ca,"matchesSelector")],Bd=function(a,c){return nh.call(a,c)};"function"===typeof Sizzle&&(nc=function(a,c){return Sizzle(a,c)[0]||null},oc=function(a,c){return Sizzle.uniqueSort(Sizzle(a,c))},
Bd=Sizzle.matchesSelector);s.selection=function(){return vf};var K=s.selection.prototype=[];K.select=function(a){var c=[],h,b,d,f;a=B(a);for(var e=-1,g=this.length;++e<g;){c.push(h=[]);h.parentNode=(d=this[e]).parentNode;for(var l=-1,q=d.length;++l<q;)(f=d[l])?(h.push(b=a.call(f,f.__data__,l,e)),b&&"__data__"in f&&(b.__data__=f.__data__)):h.push(null)}return t(c)};K.selectAll=function(a){var c=[],h,b;a=z(a);for(var d=-1,f=this.length;++d<f;)for(var e=this[d],g=-1,l=e.length;++g<l;)if(b=e[g])c.push(h=
Ba(a.call(b,b.__data__,g,d))),h.parentNode=b;return t(c)};var od={svg:"http://www.w3.org/2000/svg",xhtml:"http://www.w3.org/1999/xhtml",xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"};s.ns={prefix:od,qualify:function(a){var c=a.indexOf(":"),h=a;0<=c&&(h=a.substring(0,c),a=a.substring(c+1));return od.hasOwnProperty(h)?{space:od[h],local:a}:a}};K.attr=function(a,c){if(2>arguments.length){if("string"===typeof a){var h=this.node();
a=s.ns.qualify(a);return a.local?h.getAttributeNS(a.space,a.local):h.getAttribute(a)}for(c in a)this.each(N(c,a[c]));return this}return this.each(N(a,c))};K.classed=function(a,c){if(2>arguments.length){if("string"===typeof a){var h=this.node(),b=(a=a.trim().split(/^|\s+/g)).length,d=-1;if(c=h.classList)for(;++d<b;){if(!c.contains(a[d]))return!1}else for(c=h.getAttribute("class");++d<b;)if(!Z(a[d]).test(c))return!1;return!0}for(c in a)this.each(E(c,a[c]));return this}return this.each(E(a,c))};K.style=
function(a,c,h){var b=arguments.length;if(3>b){if("string"!==typeof a){2>b&&(c="");for(h in a)this.each(L(h,a[h],c));return this}if(2>b)return X.getComputedStyle(this.node(),null).getPropertyValue(a);h=""}return this.each(L(a,c,h))};K.property=function(a,c){if(2>arguments.length){if("string"===typeof a)return this.node()[a];for(c in a)this.each(sa(c,a[c]));return this}return this.each(sa(a,c))};K.text=function(a){return arguments.length?this.each("function"===typeof a?function(){var c=a.apply(this,
arguments);this.textContent=null==c?"":c}:null==a?function(){this.textContent=""}:function(){this.textContent=a}):this.node().textContent};K.html=function(a){return arguments.length?this.each("function"===typeof a?function(){var c=a.apply(this,arguments);this.innerHTML=null==c?"":c}:null==a?function(){this.innerHTML=""}:function(){this.innerHTML=a}):this.node().innerHTML};K.append=function(a){a=A(a);return this.select(function(){return this.appendChild(a.apply(this,arguments))})};K.insert=function(a,
c){a=A(a);c=B(c);return this.select(function(){return this.insertBefore(a.apply(this,arguments),c.apply(this,arguments))})};K.remove=function(){return this.each(function(){var a=this.parentNode;a&&a.removeChild(this)})};K.data=function(a,c){function h(a,h){var d,f=a.length,e=h.length,g=Math.min(f,e),n=Array(e),v=Array(e),w=Array(f),m,t;if(c){var g=new b,I=new b,s=[],x;for(d=-1;++d<f;)x=c.call(m=a[d],m.__data__,d),g.has(x)?w[d]=m:g.set(x,m),s.push(x);for(d=-1;++d<e;)x=c.call(h,t=h[d],d),(m=g.get(x))?
(n[d]=m,m.__data__=t):I.has(x)||(v[d]={__data__:t}),I.set(x,t),g.remove(x);for(d=-1;++d<f;)g.has(s[d])&&(w[d]=a[d])}else{for(d=-1;++d<g;)m=a[d],t=h[d],m?(m.__data__=t,n[d]=m):v[d]={__data__:t};for(;d<e;++d)v[d]={__data__:h[d]};for(;d<f;++d)w[d]=a[d]}v.update=n;v.parentNode=n.parentNode=w.parentNode=a.parentNode;l.push(v);q.push(n);u.push(w)}var d=-1,f=this.length,e,g;if(!arguments.length){for(a=Array(f=(e=this[0]).length);++d<f;)if(g=e[d])a[d]=g.__data__;return a}var l=Cd([]),q=t([]),u=t([]);if("function"===
typeof a)for(;++d<f;)h(e=this[d],a.call(e,e.parentNode.__data__,d));else for(;++d<f;)h(e=this[d],a);q.enter=function(){return l};q.exit=function(){return u};return q};K.datum=function(a){return arguments.length?this.property("__data__",a):this.property("__data__")};K.filter=function(a){var c=[],h,b,d;"function"!==typeof a&&(a=H(a));for(var f=0,e=this.length;f<e;f++){c.push(h=[]);h.parentNode=(b=this[f]).parentNode;for(var g=0,l=b.length;g<l;g++)(d=b[g])&&a.call(d,d.__data__,g)&&h.push(d)}return t(c)};
K.order=function(){for(var a=-1,c=this.length;++a<c;)for(var h=this[a],b=h.length-1,d=h[b],f;0<=--b;)if(f=h[b])d&&d!==f.nextSibling&&d.parentNode.insertBefore(f,d),d=f;return this};K.sort=function(a){a=J.apply(this,arguments);for(var c=-1,h=this.length;++c<h;)this[c].sort(a);return this.order()};K.each=function(a){return V(this,function(c,h,b){a.call(c,c.__data__,h,b)})};K.call=function(a){var c=Ba(arguments);a.apply(c[0]=this,c);return this};K.empty=function(){return!this.node()};K.node=function(){for(var a=
0,c=this.length;a<c;a++)for(var h=this[a],b=0,d=h.length;b<d;b++){var f=h[b];if(f)return f}return null};K.size=function(){var a=0;this.each(function(){++a});return a};var ta=[];s.selection.enter=Cd;s.selection.enter.prototype=ta;ta.append=K.append;ta.empty=K.empty;ta.node=K.node;ta.call=K.call;ta.size=K.size;ta.select=function(a){for(var c=[],h,b,d,f,e,g=-1,l=this.length;++g<l;){d=(f=this[g]).update;c.push(h=[]);h.parentNode=f.parentNode;for(var q=-1,u=f.length;++q<u;)(e=f[q])?(h.push(d[q]=b=a.call(f.parentNode,
e.__data__,q,g)),b.__data__=e.__data__):h.push(null)}return t(c)};ta.insert=function(a,c){2>arguments.length&&(c=Rf(this));return K.insert.call(this,a,c)};K.transition=function(){for(var a=Ta||++wf,c=[],h,b,d=$b||{time:Date.now(),ease:og,delay:0,duration:250},f=-1,e=this.length;++f<e;){c.push(h=[]);for(var g=this[f],l=-1,q=g.length;++l<q;)(b=g[l])&&Sb(b,l,a,d),h.push(b)}return mb(c,a)};K.interrupt=function(){return this.each(pb)};s.select=function(a){a=["string"===typeof a?nc(a,ga):a];a.parentNode=
Ca;return t([a])};s.selectAll=function(a){a=Ba("string"===typeof a?oc(a,ga):a);a.parentNode=Ca;return t([a])};var vf=s.select(Ca);K.on=function(a,c,h){var b=arguments.length;if(3>b){if("string"!==typeof a){2>b&&(c=!1);for(h in a)this.each(Dd(h,a[h],c));return this}if(2>b)return(b=this.node()["__on"+a])&&b._;h=!1}return this.each(Dd(a,c,h))};var pc=s.map({mouseenter:"mouseover",mouseleave:"mouseout"});pc.forEach(function(a){"on"+a in ga&&pc.remove(a)});var qc=e(Ca.style,"userSelect"),Uf=0;s.mouse=
function(a){return Gd(a,x())};var rc=/WebKit/.test(X.navigator.userAgent)?-1:0;s.touches=function(a,c){2>arguments.length&&(c=x().touches);return c?Ba(c).map(function(c){var b=Gd(a,c);b.identifier=c.identifier;return b}):[]};s.behavior.drag=function(){function a(){this.on("mousedown.drag",d).on("touchstart.drag",f)}function c(a,c,d,f){return function(){function e(){x.on(d+"."+q,null).on(f+"."+q,null);y(m&&s.event.target===l);n({type:"dragend"})}var g=this.parentNode,n=h.of(this,arguments),l=s.event.target,
w=a(),q=null==w?"drag":"drag-"+w,u=c(g,w),m=0,t,x=s.select(X).on(d+"."+q,function(){if(!g)return e();var a=c(g,w),h=a[0]-u[0],b=a[1]-u[1];m=m|h|b;u=a;n({type:"drag",x:a[0]+t[0],y:a[1]+t[1],dx:h,dy:b})}).on(f+"."+q,e),y=qb();b?(t=b.apply(this,arguments),t=[t.x-u[0],t.y-u[1]]):t=[0,0];n({type:"dragstart"})}}var h=y(a,"drag","dragstart","dragend"),b=null,d=c(l,s.mouse,"mousemove","mouseup"),f=c(function(){return s.event.changedTouches[0].identifier},function(a,c){return s.touches(a).filter(function(a){return a.identifier===
...
if(!d.length)return!1;this.__rollback();var e=this._get_parent(d),g=b([]),l=this;d.each(function(){g=g.add(l._get_prev(this))});d=d.detach();-1!==e&&0===e.find("> ul > li").length&&e.removeClass("jstree-open jstree-closed").addClass("jstree-leaf");this.clean_node(e);this.__callback({obj:d,prev:g,parent:e});return d},prepare_move:function(d,e,g,m,p){var t={};t.ot=b.jstree._reference(d)||this;t.o=t.ot._get_node(d);t.r=-1===e?-1:this._get_node(e);t.p="undefined"===typeof g||!1===g?"last":g;if(p||!l.o||
l.o[0]!==t.o[0]||l.r[0]!==t.r[0]||l.p!==t.p){t.ot=b.jstree._reference(t.o)||this;t.rt=b.jstree._reference(t.r)||this;if(-1!==t.r&&t.r){if(!/^(before|after)$/.test(t.p)&&!this._is_loaded(t.r))return this.load_node(t.r,function(){this.prepare_move(d,e,g,m,!0)});switch(t.p){case "before":t.cp=t.r.index();t.cr=t.rt._get_parent(t.r);break;case "after":t.cp=t.r.index()+1;t.cr=t.rt._get_parent(t.r);break;case "inside":case "first":t.cp=0;t.cr=t.r;break;case "last":t.cp=t.r.find(" > ul > li").length;t.cr=
...
d=this._get_node(d);return-1==d||!d||!g.ajax&&!g.progressive_render&&!b.isFunction(g.data)||d.is(".jstree-open, .jstree-leaf")||0<d.children("ul").children("li").length},refresh:function(d){d=this._get_node(d);var g=this._get_settings().json_data;d&&-1!==d&&g.progressive_unload&&(b.isFunction(g.data)||g.ajax)&&d.removeData("jstree_children");return this.__call_old()},load_node_json:function(d,g,e){var l=this.get_settings().json_data,f,m=function(){};f=function(){};if((d=this._get_node(d))&&-1!==d&&
(l.progressive_render||l.progressive_unload)&&!d.is(".jstree-open, .jstree-leaf")&&0===d.children("ul").children("li").length&&d.data("jstree_children")){if(f=this._parse_json(d.data("jstree_children"),d))d.append(f),l.progressive_unload||d.removeData("jstree_children");this.clean_node(d);g&&g.call(this)}else{if(d&&-1!==d){if(d.data("jstree_is_loading"))return;d.data("jstree_is_loading",!0)}switch(!0){case !l.data&&!l.ajax:throw"Neither data nor ajax settings supplied.";case b.isFunction(l.data):l.data.call(this,
...
b.isFunction(l.ajax.data)&&(l.ajax.data=l.ajax.data.call(this,d)),b.ajax(l.ajax)}}},_parse_json:function(d,g,e){var l=!1,f=this._get_settings(),m=f.json_data,u=f.core.html_titles,p;if(!d)return l;m.progressive_unload&&g&&-1!==g&&g.data("jstree_children",l);if(b.isArray(d)){l=b("<ul>");if(!d.length)return!1;f=0;for(m=d.length;f<m;f++)p=this._parse_json(d[f],g,!0),p.length&&(l=l.append(p));l=l.children()}else{"string"==typeof d&&(d={data:d});if(!d.data&&""!==d.data)return l;l=b("<li />");d.attr&&l.attr(d.attr);
d.metadata&&l.data(d.metadata);d.state&&l.addClass("jstree-"+d.state);b.isArray(d.data)||(p=d.data,d.data=[],d.data.push(p));b.each(d.data,function(e,f){p=b("<a />");b.isFunction(f)&&(f=f.call(this,d));if("string"==typeof f)p.attr("href","#")[u?"html":"text"](f);else f.attr||(f.attr={}),f.attr.href||(f.attr.href="#"),p.attr(f.attr)[u?"html":"text"](f.title),f.language&&p.addClass(f.language);p.prepend("<ins class='jstree-icon'>&#160;</ins>");!f.icon&&d.icon&&(f.icon=d.icon);f.icon&&(-1===f.icon.indexOf("/")?
p.children("ins").addClass(f.icon):p.children("ins").css("background","url('"+f.icon+"') center center no-repeat"));l.append(p)});l.prepend("<ins class='jstree-icon'>&#160;</ins>");d.children&&(m.progressive_render&&"open"!==d.state?l.addClass("jstree-closed").data("jstree_children",d.children):(m.progressive_unload&&l.data("jstree_children",d.children),b.isArray(d.children)&&d.children.length&&(p=this._parse_json(d.children,g,!0),p.length&&(g=b("<ul />"),g.append(p),l.append(g)))))}e||(e=b("<ul />"),
e.append(l),l=e);return l},get_json:function(d,g,e,l){var f=[],m=this._get_settings(),u=this,p,r,t,B,z,N;(d=this._get_node(d))&&-1!==d||(d=this.get_container().find("> ul > li"));g=b.isArray(g)?g:["id","class"];!l&&this.data.types&&g.push(m.types.type_attr);e=b.isArray(e)?e:[];d.each(function(){t=b(this);p={data:[]};g.length&&(p.attr={});b.each(g,function(b,d){(r=t.attr(d))&&r.length&&r.replace(/jstree[^ ]*/ig,"").length&&(p.attr[d]=(" "+r).replace(/ jstree[^ ]*/ig,"").replace(/\s+$/ig," ").replace(/^ /,
"").replace(/ $/,""))});t.hasClass("jstree-open")&&(p.state="open");t.hasClass("jstree-closed")&&(p.state="closed");t.data()&&(p.metadata=t.data());B=t.children("a");B.each(function(){z=b(this);e.length||-1!==b.inArray("languages",m.plugins)||z.children("ins").get(0).style.backgroundImage.length||z.children("ins").get(0).className&&z.children("ins").get(0).className.replace(/jstree[^ ]*|$/ig,"").length?(N=!1,-1!==b.inArray("languages",m.plugins)&&b.isArray(m.languages)&&m.languages.length&&b.each(m.languages,
function(b,d){if(z.hasClass(d))return N=d,!1}),r={attr:{},title:u.get_text(z,N)},b.each(e,function(b,d){r.attr[d]=(" "+(z.attr(d)||"")).replace(/ jstree[^ ]*/ig,"").replace(/\s+$/ig," ").replace(/^ /,"").replace(/ $/,"")}),-1!==b.inArray("languages",m.plugins)&&b.isArray(m.languages)&&m.languages.length&&b.each(m.languages,function(b,d){if(z.hasClass(d))return r.language=d,!0}),z.children("ins").get(0).className.replace(/jstree[^ ]*|$/ig,"").replace(/^\s+$/ig,"").length&&(r.icon=z.children("ins").get(0).className.replace(/jstree[^ ]*|$/ig,
...
e){var l=this._get_settings().languages,f=this._get_settings().core.strings;b.isArray(l)&&l.length&&(e=e&&-1!=b.inArray(e,l)?e:this.data.languages.current_language);return f[e]&&f[e][d]?f[e][d]:f[d]?f[d]:d},get_text:function(d,e){d=this._get_node(d)||this.data.ui.last_selected;if(!d.size())return!1;var l=this._get_settings().languages,f=this._get_settings().core.html_titles;b.isArray(l)&&l.length?(e=e&&-1!=b.inArray(e,l)?e:this.data.languages.current_language,d=d.children("a."+e)):d=d.children("a:eq(0)");
if(f)return d=d.clone(),d.children("INS").remove(),d.html();d=d.contents().filter(function(){return 3==this.nodeType})[0];return d.nodeValue},set_text:function(d,e,l){d=this._get_node(d)||this.data.ui.last_selected;if(!d.size())return!1;var f=this._get_settings().languages,m=this._get_settings().core.html_titles;b.isArray(f)&&f.length?(l=l&&-1!=b.inArray(l,f)?l:this.data.languages.current_language,d=d.children("a."+l)):d=d.children("a:eq(0)");if(m)return f=d.children("INS").clone(),d.html(e).prepend(f),
this.__callback({obj:d,name:e,lang:l}),!0;d=d.contents().filter(function(){return 3==this.nodeType})[0];this.__callback({obj:d,name:e,lang:l});return d.nodeValue=e},_load_css:function(){var g=this._get_settings().languages,e="/* languages css */",l=".jstree-"+this.get_index()+" a",f;if(b.isArray(g)&&g.length){this.data.languages.current_language=g[0];for(f=0;f<g.length;f++)e+=l+"."+g[f]+" {",g[f]!=this.data.languages.current_language&&(e+=" display:none; "),e+=" } ";d=b.vakata.css.add_sheet({str:e,
...
this.data.dnd.i2&&clearInterval(this.data.dnd.i2);this.data.dnd.after=!1;this.data.dnd.before=!1;this.data.dnd.inside=!1;this.data.dnd.off=!1;this.data.dnd.prepared=!1;this.data.dnd.w=!1;this.data.dnd.to1=!1;this.data.dnd.to2=!1;this.data.dnd.i1=!1;this.data.dnd.i2=!1;this.data.dnd.active=!1;this.data.dnd.foreign=!1;e&&e.css({top:"-2000px"});l&&l.css({top:"-2000px"})},this)).bind("drag_start.vakata",b.proxy(function(d,e){if(e.data.jstree){var f=b(e.event.target);f.closest(".jstree").hasClass("jstree-"+
this.get_index())&&this.dnd_enter(f)}},this));var f=this._get_settings().dnd;f.drag_target&&b(document).delegate(f.drag_target,"mousedown.jstree-"+this.get_index(),b.proxy(function(f){d=f.target;b.vakata.dnd.drag_start(f,{jstree:!0,obj:f.target},"<ins class='jstree-icon'></ins>"+b(f.target).text());this.data.themes&&(e&&e.attr("class","jstree-"+this.data.themes.theme),l&&l.attr("class","jstree-"+this.data.themes.theme),b.vakata.dnd.helper.attr("class","jstree-dnd-helper jstree-"+this.data.themes.theme));
