...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'h1ds_node', 'rght')

        # Deleting field 'Node.lft'
        db.delete_column(u'h1ds_node', 'lft')

        # Deleting field 'Node.level'
        db.delete_column(u'h1ds_node', 'level')

        # Deleting field 'Node.tree_id'
        db.delete_column(u'h1ds_node', 'tree_id')


        # Changing field 'Node.parent'
        db.alter_column(u'h1ds_node', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['h1ds.Node']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Node.parent'
        db.alter_column(u'h1ds_node', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['h1ds.Node']))
