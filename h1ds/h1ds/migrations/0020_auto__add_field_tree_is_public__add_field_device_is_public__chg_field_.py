...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tree.is_public'
        db.add_column(u'h1ds_tree', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding M2M table for field allowed_users on 'Tree'
        db.create_table(u'h1ds_tree_allowed_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tree', models.ForeignKey(orm[u'h1ds.tree'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(u'h1ds_tree_allowed_users', ['tree_id', 'user_id'])

        # Adding field 'Device.is_public'
        db.add_column(u'h1ds_device', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding M2M table for field allowed_users on 'Device'
        db.create_table(u'h1ds_device_allowed_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('device', models.ForeignKey(orm[u'h1ds.device'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(u'h1ds_device_allowed_users', ['device_id', 'user_id'])


        # Changing field 'Device.latest_shot'
        db.alter_column(u'h1ds_device', 'latest_shot_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['h1ds.Shot']))

        # Changing field 'Shot.device'
        db.alter_column(u'h1ds_shot', 'device_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['h1ds.Device']))

    def backwards(self, orm):
        # Deleting field 'Tree.is_public'
        db.delete_column(u'h1ds_tree', 'is_public')

        # Removing M2M table for field allowed_users on 'Tree'
        db.delete_table('h1ds_tree_allowed_users')

        # Deleting field 'Device.is_public'
        db.delete_column(u'h1ds_device', 'is_public')

        # Removing M2M table for field allowed_users on 'Device'
        db.delete_table('h1ds_device_allowed_users')


        # Changing field 'Device.latest_shot'
        db.alter_column(u'h1ds_device', 'latest_shot_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['h1ds.Shot']))

        # Changing field 'Shot.device'
        db.alter_column(u'h1ds_shot', 'device_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['h1ds.Device'], on_delete=models.PROTECT))
    ...
    models = {
        ...
        u'h1ds.node': {
            ...
            'subtree': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['h1ds.SubTree']"})
        },
        u'h1ds.nodepath': {
