...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.latest_shot'
        db.add_column(u'h1ds_device', 'latest_shot',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['h1ds.Shot']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.latest_shot'
        db.delete_column(u'h1ds_device', 'latest_shot_id')
    ...
    models = {
        ...
        u'h1ds.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latest_shot': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': u"orm['h1ds.Shot']"}),
