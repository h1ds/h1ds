...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Node.dimension'
        db.delete_column(u'h1ds_core_node', 'dimension')

        # Adding field 'Node.n_dimensions'
        db.add_column(u'h1ds_core_node', 'n_dimensions',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Node.n_channels'
        db.add_column(u'h1ds_core_node', 'n_channels',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Node.dimension'
        db.add_column(u'h1ds_core_node', 'dimension',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Node.n_dimensions'
        db.delete_column(u'h1ds_core_node', 'n_dimensions')

        # Deleting field 'Node.n_channels'
        db.delete_column(u'h1ds_core_node', 'n_channels')
    ...
    models = {
        ...
        u'h1ds_core.node': {
            ...
            'n_channels': ('django.db.models.fields.PositiveSmallIntegerField', [], {'blank': 'True'}),
