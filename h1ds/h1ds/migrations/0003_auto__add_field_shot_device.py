...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shot.device'
        db.add_column(u'h1ds_shot', 'device',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['h1ds.Device']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Shot.device'
        db.delete_column(u'h1ds_shot', 'device_id')
