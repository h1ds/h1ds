...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tree.data_backend'
        db.alter_column(u'h1ds_tree', 'data_backend', self.gf('django.db.models.fields.CharField')(max_length=4))

    def backwards(self, orm):

        # Changing field 'Tree.data_backend'
        db.alter_column(u'h1ds_tree', 'data_backend', self.gf('django.db.models.fields.CharField')(max_length=3))
