...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SubTree'
        db.create_table(u'h1ds_subtree', (
            ...
            ('subtree_hash', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40)),
        ))
        db.send_create_signal(u'h1ds', ['SubTree'])

        # Adding M2M table for field children on 'SubTree'
        db.create_table(u'h1ds_subtree_children', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_subtree', models.ForeignKey(orm[u'h1ds.subtree'], null=False)),
            ('to_subtree', models.ForeignKey(orm[u'h1ds.subtree'], null=False))
        ))
        db.create_unique(u'h1ds_subtree_children', ['from_subtree_id', 'to_subtree_id'])


        # Changing field 'PathMap.node'
        db.alter_column(u'h1ds_pathmap', 'node_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['h1ds.SubTree']))
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'h1ds_node', (
            ...
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dtype', self.gf('django.db.models.fields.CharField')(max_length=16, blank=True)),
            ('subtree_hash', self.gf('django.db.models.fields.CharField')(max_length=40, unique=True)),
            ('has_data', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        ...
        # Deleting model 'SubTree'
        db.delete_table(u'h1ds_subtree')

        # Removing M2M table for field children on 'SubTree'
        db.delete_table('h1ds_subtree_children')


        # Changing field 'PathMap.node'
        db.alter_column(u'h1ds_pathmap', 'node_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['h1ds.Node']))
    ...
    models = {
        ...
        u'h1ds.nodepath': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nodes': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['h1ds.SubTree']", 'through': u"orm['h1ds.PathMap']", 'symmetrical': 'False'}),
        ...
        u'h1ds.pathmap': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'node': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['h1ds.SubTree']"}),
