...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Device.data_backend'
        db.alter_column(u'h1ds_device', 'data_backend', self.gf('django.db.models.fields.CharField')(max_length=4))

    def backwards(self, orm):

        # Changing field 'Device.data_backend'
        db.alter_column(u'h1ds_device', 'data_backend', self.gf('django.db.models.fields.CharField')(max_length=3))
    ...
    models = {
        ...
        u'h1ds.device': {
            ...
            'data_backend': ('django.db.models.fields.CharField', [], {'default': "'mds'", 'max_length': '4'}),
