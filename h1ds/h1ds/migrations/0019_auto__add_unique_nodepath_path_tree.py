...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'NodePath', fields ['path', 'tree']
        db.create_unique(u'h1ds_nodepath', ['path', 'tree_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'NodePath', fields ['path', 'tree']
        db.delete_unique(u'h1ds_nodepath', ['path', 'tree_id'])
