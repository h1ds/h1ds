...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NodePath.tree'
        db.delete_column(u'h1ds_nodepath', 'tree')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'NodePath.tree'
        raise RuntimeError("Cannot reverse this migration. 'NodePath.tree' and its values cannot be restored.")
