...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Node.has_data'
        db.add_column(u'h1ds_core_node', 'has_data',
        ...
        # Adding field 'Node.dtype'
        db.add_column(u'h1ds_core_node', 'dtype',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Node.has_data'
        db.delete_column(u'h1ds_core_node', 'has_data')

        # Deleting field 'Node.dimension'
        db.delete_column(u'h1ds_core_node', 'dimension')

        # Deleting field 'Node.dtype'
        db.delete_column(u'h1ds_core_node', 'dtype')
    ...
    models = {
        ...
        u'h1ds_core.node': {
            ...
            'shot': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'})
        },
        u'h1ds_core.pagelet': {
