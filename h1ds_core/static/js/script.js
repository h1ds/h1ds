...
function new_plotSignal1D(id) {
	...
	var fourier_query = getPlotQueryString([990, 'power_spectrum'],[995, 'norm_dim_range',0.0, 0.5],[999, 'resample_minmax',width_data.plot]);
	...
	function brushend() {
	    ...
	    var s = d3.event.target.extent();
	    var new_data_url = getPlotQueryString([990, 'dim_range', s[0], s[1]],[999,'resample_minmax',width_data.plot]);

	    function updateFourier(d) {
		var fourier_query = getPlotQueryString([980, 'dim_range', s[0], s[1]], [990, 'power_spectrum'], [995, 'norm_dim_range', 0.0,0.5], [999, 'resample_minmax', width_data.plot]);
...
$(document).ready(function() {
	...
	data = new_plotSignal1D("#signal-1d-placeholder");
    }
